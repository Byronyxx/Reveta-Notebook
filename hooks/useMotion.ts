...
export function useMotion() {
    ...
    useEffect(() => {
        ...
        const comfortMode = localStorage.getItem('reveta-motion') === 'comfort'
    ...
    const setComfortMode = (enabled: boolean) => {
        ...
        document.documentElement.setAttribute('data-comfort-mode', enabled ? 'true' : 'false')
        setMotionState(prev => {
    ...
    return { motionState, isReduced: motionState !== 'full', setComfortMode }
}
